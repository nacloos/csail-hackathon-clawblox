...
BASH_DEFAULT_TIMEOUT_MS="${BASH_DEFAULT_TIMEOUT_MS:-30000}"
BASH_MAX_TIMEOUT_MS="${BASH_MAX_TIMEOUT_MS:-30000}"
...
if [[ "$SANDBOX" == "1" ]]; then
  ...
  [[ -n "$SANDBOX_PYTHONPATH" ]] && bwrap_prefix+=(--setenv PYTHONPATH "$SANDBOX_PYTHONPATH")
